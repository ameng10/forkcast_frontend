...
.ghost { border:none; background:transparent; color:var(--text-muted); cursor:pointer; font-size:12px; }
...
.composer input { flex:1; padding:10px 12px; border:1px solid var(--border); border-radius:20px; background: var(--surface); color: var(--text); }
.composer input:focus { outline: 3px solid var(--focus); border-color: var(--brand-primary); }
.composer button { padding:10px 18px; border:none; border-radius:20px; background:var(--brand-primary); color:#fff; cursor:pointer; }
.composer button:hover { background: var(--brand-primary-strong); }
...
.bubble.user { margin-left:auto; background:var(--brand-primary); color:#fff; border-bottom-right-radius:4px; }
.bubble.assistant { margin-right:auto; background:#F1F5F9; color:var(--text); border:1px solid var(--border); border-bottom-left-radius:4px; }
.sender { font-size:11px; text-transform:uppercase; letter-spacing:0.05em; opacity:0.7; }
.chat-window .empty { text-align:center; color:var(--text-muted); margin-top:40px; }
.facts-card { display:flex; flex-direction:column; gap:12px; }
.row { display:flex; gap:8px; align-items:center; }
.facts-card input { flex:1; padding:8px 10px; border:1px solid var(--border); border-radius:8px; background: var(--surface); color: var(--text); }
.facts-card input:focus { outline: 3px solid var(--focus); border-color: var(--brand-primary); }
.facts-card button { padding:8px 12px; border:none; border-radius:8px; background:var(--brand-primary); color:#fff; cursor:pointer; }
.facts-card button:hover { background: var(--brand-primary-strong); }
.facts-card button:disabled { opacity:0.5; cursor:not-allowed; }
.facts-card button.ghost { background:transparent; color:var(--text-muted); border:1px solid transparent; padding:4px 8px; }
...
.fact-row { display:flex; justify-content:space-between; gap:12px; align-items:center; padding:10px 12px; border:1px solid var(--border); border-radius:10px; background:#F8FAFC; }
